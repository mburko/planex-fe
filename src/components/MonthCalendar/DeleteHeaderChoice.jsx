            ...
            >
                ...
                <div className={props.state ? "hd_choice" : "hd_choice_disabled"}>
                    <div className="hd_choice_text"
                        onClick={() => {if(props.currEvent===null){props.deleteTask(props.currTask, props.currTaskDate); props.setCurrTask(null)} else {props.deleteEvent(props.currEvent, props.currEvDate); props.setCurrEvent(null)}}}>Confirm</div>
